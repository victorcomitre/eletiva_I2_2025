...
<p>Crie um formulário que permita ao usuário inserir dois números. O script PHP deve dividir o primeiro número 
    pelo segundo e exibir o resultado. Inclua uma verificação para evitar divisão por zero.</p>
<form method="post">
    <div class="mb-3">
